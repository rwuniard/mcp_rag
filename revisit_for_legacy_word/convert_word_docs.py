...
def main():
    ...
    if not doc_files:
        ...
        print(
            "✅ All Word documents are already in .DOCX format or no Word docs present"
        )
        return
    ...
    if successful_conversions > 0:
        print("\n💡 Next steps:")
        print("   1. Run document storage: python main.py store")
        print("   2. Verify Word docs stored: python test_local_chroma.py")
        print('   3. Search Word content: python main.py search "legal case"')
