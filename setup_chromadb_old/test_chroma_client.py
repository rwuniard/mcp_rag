...
def test_docker_chromadb():
    ...
    try:
        ...
        print("✅ Successfully connected to ChromaDB Docker")
...
def create_test_collection(client):
    ...
    try:
        ...
        if collection.count() == 0:
            ...
            collection.add(documents=test_docs, metadatas=test_metadata, ids=test_ids)
    ...
    try:
        ...
        if results["documents"]:
            ...
            for i, doc in enumerate(results["documents"][0]):
                distance = (
                    results["distances"][0][i] if results.get("distances") else "N/A"
                )
        ...
        print(
            "💡 This might be because embeddings aren't configured for this collection"
        )
